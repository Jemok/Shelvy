    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="customer_registration">Customer Accounts</a>
                </li>
                <li>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <p class="lead">{{ $shop->shop_description }}</p>
            ...
            <div class="list-group">
                <a href="#" class="list-group-item"><strong>Manufacturers</strong></a>
                <a href="#" class="list-group-item">Manufacturer 1</a>
                <a href="#" class="list-group-item">Manufacturer 2</a>
                <a href="#" class="list-group-item">Manufacturer 3</a>
                <a href="#" class="list-group-item">Manufacturer 4</a>
                <a href="#" class="list-group-item">Manufacturer 5</a>
            </div>
        </div>
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        <img src="images/320x150.gif" alt="">
                        <div class="caption">
