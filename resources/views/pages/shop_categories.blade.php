...
<hgroup class="mb20">
    ...
    <h2 class="lead"><strong class="text-danger">100</strong> results for <strong class="text-danger"></strong></h2>
    ...
    <form class="form-group-sm" method="GET">
        <div class="form-group-sm" style="display:inline;">
            <div class="input-group">
                <input class="form-control" type="search" name="filter" placeholder="filter results by area here">
...
<article class="search-result row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 excerpet">
        ...
        <h3><a href="{{ asset('/'. $shop->slug)}}" title="">{{ $shop->shop_name }} - {{ $shop->shop_category}} - {{ $shop->shop_location}} - {{ $shop->shop_building }}</a></h3>
